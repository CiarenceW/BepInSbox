...
pub const HOSTFXR_DELEGATE_TYPE_HDT_COM_ACTIVATION: HostfxrDelegateType = 0;
pub const HOSTFXR_DELEGATE_TYPE_HDT_LOAD_IN_MEMORY_ASSEMBLY: HostfxrDelegateType = 1;
pub const HOSTFXR_DELEGATE_TYPE_HDT_WINRT_ACTIVATION: HostfxrDelegateType = 2;
pub const HOSTFXR_DELEGATE_TYPE_HDT_COM_REGISTER: HostfxrDelegateType = 3;
pub const HOSTFXR_DELEGATE_TYPE_HDT_COM_UNREGISTER: HostfxrDelegateType = 4;
pub const HOSTFXR_DELEGATE_TYPE_HDT_LOAD_ASSEMBLY_AND_GET_FUNCTION_POINTER: HostfxrDelegateType = 5;
pub const HOSTFXR_DELEGATE_TYPE_HDT_GET_FUNCTION_POINTER: HostfxrDelegateType = 6;
pub const HOSTFXR_DELEGATE_TYPE_HDT_LOAD_ASSEMBLY: HostfxrDelegateType = 7;
pub const HOSTFXR_DELEGATE_TYPE_HDT_LOAD_ASSEMBLY_BYTES: HostfxrDelegateType = 8;
...
pub const CUM : &'static str = "CUM";

pub type HostfxrDelegateType = ::std::os::raw::c_uint;
...
pub type HostfxrHandle = *mut ::std::os::raw::c_void;
...
pub type HostfxrGetDotnetEnvironmentInfoResultFn =
    unsafe extern "C" fn(
        ...
        result_context: *mut ::std::os::raw::c_void,
    );
