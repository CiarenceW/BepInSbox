...
namespace BepInSbox.Preloader.Core.Patching;
...
public class AssemblyPatcher : IDisposable
{
    ...
    {
        DumpedAssembliesPath = Utility.CombinePaths(Paths.BepInSboxRootPath, "DumpedAssemblies", Paths.ProcessName)
    };
    ...
    private ManualLogSource Logger { get; } = BepInSbox.Logging.Logger.CreateLogSource("AssemblyPatcher");
    ...
    public void PatchAndLoad()
    {
        ...
        if (ConfigBreakBeforeLoadAssemblies.Value)
        {
            Logger.Log(LogLevel.Info,
                       $"BepInS&x is about load the following assemblies:\n{string.Join("\n", patchedAssemblies.ToArray())}");
    ...
    private static readonly ConfigEntry<bool> ConfigDumpAssemblies = ConfigFile.CoreConfig.Bind(
     ...
     false,
     "If enabled, BepInS&x will save patched assemblies into BepInSbox/DumpedAssemblies.\nThis can be used by developers to inspect and debug preloader patchers.");
    ...
    private static readonly ConfigEntry<bool> ConfigLoadDumpedAssemblies = ConfigFile.CoreConfig.Bind(
     ...
     false,
     "If enabled, BepInS&x will load patched assemblies from BepInSbox/DumpedAssemblies instead of memory.\nThis can be used to be able to load patched assemblies into debuggers like dnSpy.\nIf set to true, will override DumpAssemblies.");
    ...
    private static readonly ConfigEntry<bool> ConfigBreakBeforeLoadAssemblies = ConfigFile.CoreConfig.Bind(
     ...
     false,
     "If enabled, BepInS&x will call Debugger.Break() once before loading patched assemblies.\nThis can be used with debuggers like dnSpy to install breakpoints into patched assemblies before they are loaded.");
