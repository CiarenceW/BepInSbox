...
namespace BepInSbox.Configuration;
...
public class ConfigFile : IDictionary<ConfigDefinition, ConfigEntryBase>
{
    ...
    public static ConfigFile CoreConfig { get; } = new(Paths.BepInSboxConfigPath, true);
    ...
    ///     <see cref="Bind{T}(BepInSbox.Configuration.ConfigDefinition,T,BepInSbox.Configuration.ConfigDescription)" />.
    /// </summary>
