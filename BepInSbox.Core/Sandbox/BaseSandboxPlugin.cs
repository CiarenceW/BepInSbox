...
{
    /// <summary>
    ///     Base S&amp;Box plugin component, this is what gets detected and loaded by BepInSbox's chainloader :)
    /// </summary>
    public abstract class BaseSandboxPlugin : Sandbox.Component
    {
        ...
        protected BaseSandboxPlugin()
        {
            ...
            HarmonyInstance = new Harmony("BepInS&x.Plugin." + metadata.GUID);

            Logger = BepInSbox.Logging.Logger.CreateLogSource(metadata.Name);
