...
public class BepInDependency : Attribute, ICacheable
{
    ...
    /// <summary>
    ///     Marks this <see cref="BaseSandboxPlugin" /> as dependent on another plugin. The other plugin will be loaded before
    ///     this one.
...
{
    /// <summary>
    ///     Marks this <see cref="BaseSandboxPlugin" /> as incompatible with another plugin.
